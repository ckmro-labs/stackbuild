...
import RendererWrapper0 from '/Users/sassali/go/src/github.com/laidingqing/stackbuild/web/src/pages/.umi/LocaleWrapper.jsx';
...
let routes = [
  {
    ...
    component: _dvaDynamic({
      ...
      LoadingComponent: require('/Users/sassali/go/src/github.com/laidingqing/stackbuild/web/src/components/PageLoading/index')
        .default,
    }),
    routes: [
      {
      ...
      },
      {
        ...
        component: _dvaDynamic({
          app: window.g_app,
          models: () => [
            import(/* webpackChunkName: 'p__User__models__register.js' */ '/Users/sassali/go/src/github.com/laidingqing/stackbuild/web/src/pages/User/models/register.js').then(
              m => {
      ...
      },
      {
        component: () =>
          React.createElement(
            require('/Users/sassali/go/src/github.com/laidingqing/stackbuild/web/node_modules/_umi-build-dev@1.7.8@umi-build-dev/lib/plugins/404/NotFound.js')
              .default,
        ...
        routes: [
          {
            ...
            component: _dvaDynamic({
              app: window.g_app,
              models: () => [
                import(/* webpackChunkName: 'p__Dashboard__models__activities.js' */ '/Users/sassali/go/src/github.com/laidingqing/stackbuild/web/src/pages/Dashboard/models/activities.js').then(
                  m => {
                    return { namespace: 'activities', ...m.default };
                  }
                ),
                import(/* webpackChunkName: 'p__Dashboard__models__chart.js' */ '/Users/sassali/go/src/github.com/laidingqing/stackbuild/web/src/pages/Dashboard/models/chart.js').then(
                  m => {
                    return { namespace: 'chart', ...m.default };
                  }
                ),
                import(/* webpackChunkName: 'p__Dashboard__models__monitor.js' */ '/Users/sassali/go/src/github.com/laidingqing/stackbuild/web/src/pages/Dashboard/models/monitor.js').then(
                  m => {
        ...
        routes: [
          {
            ...
            component: _dvaDynamic({
              app: window.g_app,
              models: () => [
                import(/* webpackChunkName: 'p__Forms__models__form.js' */ '/Users/sassali/go/src/github.com/laidingqing/stackbuild/web/src/pages/Forms/models/form.js').then(
                  m => {
        ...
        routes: [
          {
            ...
            component: _dvaDynamic({
              app: window.g_app,
              models: () => [
                import(/* webpackChunkName: 'p__List__models__rule.js' */ '/Users/sassali/go/src/github.com/laidingqing/stackbuild/web/src/pages/List/models/rule.js').then(
                  m => {
        ...
        routes: [
          {
            ...
            component: _dvaDynamic({
              app: window.g_app,
              models: () => [
                import(/* webpackChunkName: 'p__Profile__models__profile.js' */ '/Users/sassali/go/src/github.com/laidingqing/stackbuild/web/src/pages/Profile/models/profile.js').then(
                  m => {
        ...
        routes: [
          {
            ...
            component: _dvaDynamic({
              app: window.g_app,
              models: () => [
                import(/* webpackChunkName: 'p__Exception__models__error.js' */ '/Users/sassali/go/src/github.com/laidingqing/stackbuild/web/src/pages/Exception/models/error.js').then(
                  m => {
        ...
        routes: [
          ...
          },
          {
            ...
            component: _dvaDynamic({
              app: window.g_app,
              models: () => [
                import(/* webpackChunkName: 'p__Account__Settings__models__geographic.js' */ '/Users/sassali/go/src/github.com/laidingqing/stackbuild/web/src/pages/Account/Settings/models/geographic.js').then(
                  m => {
